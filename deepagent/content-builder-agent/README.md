...
uv run python content_writer_tools.py "Write a blog post about prompt engineering"
```

**More examples:**
```bash
uv run python content_writer_tools.py "Create a LinkedIn post about AI agents"
uv run python content_writer_tools.py "Write a Twitter thread about the future of coding"
```
